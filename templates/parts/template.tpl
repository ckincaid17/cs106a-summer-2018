<!--
	...
	templateFile should contain the filepath to the template to render within this template.
-->
<!DOCTYPE html>
<html lang="en">
	<head>
		...
		<link rel="shortcut icon" href="{{pathToRoot}}images/icons/stanford-favicon.png" type="image/x-icon">
		<title>{{title}}</title>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<div class="footer">
						<p class="text-center">
							&#169; Stanford 2017 &#124; Created by Chris Piech, updated by Nick Troccoli.<br/>
